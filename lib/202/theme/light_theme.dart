  ...
  LightTheme() {
    theme = ThemeData(
        ...
        floatingActionButtonTheme:
            const FloatingActionButtonThemeData(backgroundColor: Colors.deepPurple, foregroundColor: Colors.white),
...
class _LightColors {
  ...
  final Color _plum = const Color.fromARGB(255, 103, 55, 103);
  final Color _ultravioletOnsible = const Color.fromARGB(255, 182, 67, 214);
  final Color _amethystLightViolet = const Color.fromARGB(255, 206, 196, 207);
  final Color _fertilityGreen = const Color.fromARGB(255, 102, 255, 0);
  final Color _extraLife = const Color.fromARGB(255, 102, 186, 18);
}
